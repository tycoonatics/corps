...
st.markdown("""
    ...
    /* Absolute target to bury the lower-right hosting bar/iframe overlays */
    ...
    /* Force high-contrast values inside Metric Cards for both light and dark backgrounds */
    ...
    div[data-testid="stMetricValue"] div {
        color: #ffffff !important; /* Forces metric numbers to stay white and readable */
        font-weight: bold !important;
    }
    div[data-testid="stMetricLabel"] {
        color: #cbd5e1 !important; /* Forces sublabels to remain visible light gray */
    }
